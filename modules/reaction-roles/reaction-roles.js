        ...
        if(channel.id === interaction.channel.id){
            ...
            if(interaction.member.roles.cache.has(role.id)){
                ...
                await interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed().setColor(config.colors.successColor).setDescription("Successfully removed " + role.name)
                    ],
                    ephemeral: true
                });
            } else {
                ...
                await interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed().setColor(config.colors.errorColor).setDescription("Successfully added " + role.name)
                    ],
                    ephemeral: true
                });
            }
